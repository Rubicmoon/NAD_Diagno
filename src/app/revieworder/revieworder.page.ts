...
export class RevieworderPage implements OnInit {
  ...
  order_type:any;
  sample_collection_type:any;
  sample_collection_type_active:boolean=false;
  prescription:any='';
  urlpath: string ='https://nadhospital.com/app/webservices/prescription-upload';
  ...
  sampleClick(){
    this.sample_collection_type_active=!this.sample_collection_type_active;
  }
  ...
  confirm_order() {
    ...
    if (this.user_id == '' || this.user_id == undefined || this.user_id == null) {
      ...
      if(this.sample_collection_type_active==true){
        this.sample_collection_type="Home Collection"
      }
      else{
        this.sample_collection_type='';
      }
      this.route.navigate(['deliveryaddress', { totalamount: this.need_to_pay,walletCheck: this.wallet_check,sample_collection_type:this.sample_collection_type,prescription:this.prescription}]);
    }
  }
  ...
  moreSlots(){
    this.route.navigate(['deliveryslots', { totalamount: this.need_to_pay,address:"not_select" ,walletCheck: this.wallet_check,sample_collection_type:this.sample_collection_type,prescription:this.prescription}]);
  }
  ...
  async filepath2(imgurl) {
    ...
    fileTransfer.upload(imgurl, this.urlpath, options1, true).then((data) => {
      ...
      var res1 = [];
      res1 = JSON.parse(data['response']);  
      console.log(res1['response'][0]);
       this.prescription = (res1['response'][0]['image_path']);
