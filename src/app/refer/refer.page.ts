...
export class ReferPage implements OnInit {
  ...
  async shareWhatsapp() {
    let loading = await this.loadingCtrl.create({
      ...
      console.log(text);
      let ur = 'https://www.ready2host.in/cm-groccy/admin/img/logo.png';
      let url="Click Here"+" "+"https://play.google.com/store/apps/details?id=com.nadhospital";
  ...
  //   var dataUrl='https://www.ready2host.in/cm-groccy/admin/img/logo.png';
  //   var sharingUrl= 'https://play.google.com/store/apps/details?id=com.ndk_mart';
  ...
  //   var sharingImage='https://www.ready2host.in/cm-groccy/admin/img/logo.png';
  //   var sharingUrl= 'https://play.google.com/store/apps/details?id=com.ndk_mart';
