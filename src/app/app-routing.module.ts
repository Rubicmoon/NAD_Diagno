...
const routes: Routes = [
  ...
  {
    path: 'verticalclider',
    loadChildren: () => import('./test/verticalclider/verticalclider.module').then( m => m.VerticalcliderPageModule)
  },  {
    path: 'topmedicines',
    loadChildren: () => import('./topmedicines/topmedicines.module').then( m => m.TopmedicinesPageModule)
  },
