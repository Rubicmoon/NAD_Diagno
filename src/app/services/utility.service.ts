...
export class UtilityService {
  ...
  getSettings(){
    this.apiserv.getSettings().subscribe(data => {
      ...
      if (response['status'] == 'Valid') {
        ...
        if(this.setting_data.google_map_location=='Yes'){
          myVar = document.createElement('script');
          var key=this.setting_data.google_map_api_key;
  ...
  //     if (response['status'] == 'Valid') { 
  //       if(response['message']=='you are using latest version'){
  //         this.router.navigate['home']
  //       }
  //       else if(this.force_update=='Yes' && response['message']!='you are using latest version'){
