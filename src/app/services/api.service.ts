...
export class ApiService {
  // base_url = "https://www.landedretail.com/webservices/";
  base_url = "https://nadhospital.com/app/webservices/";
  ...
  hotline(tag, start, limit, city_id,langugae_id,sid,sort = 'Recent') {
    let postData = new FormData();
    postData.append('tag', tag);
    postData.append('start', start);
    postData.append('limit', limit);
  ...
  deliverytothisaddress(user_id, sid, address_id, city_id,sample_collection_type,prescription) {
    let postData = new FormData();
    postData.append('user_id', user_id);
    postData.append('sid', sid);
    postData.append('address_id', address_id);
    postData.append('city_id', city_id);
    postData.append('sample_collection_type', sample_collection_type);
    postData.append('prescription', prescription);
