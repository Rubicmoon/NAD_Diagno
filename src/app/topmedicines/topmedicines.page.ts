...
@Component({
  selector: 'app-topmedicines',
  templateUrl: './topmedicines.page.html',
  styleUrls: ['./topmedicines.page.scss'],
})
export class TopmedicinesPage implements OnInit {
  ...
  async getProductList() {
    ...
    this.start = 0;
    this.limit = 10;
    this.apiserv.hotline(this.tag, this.start, this.limit, this.city_id, language_id, this.sid,this.sort_type).subscribe(data => {
